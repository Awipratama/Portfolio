<div class="main-profile-content p-10 shadow-2xl rounded-2xl h-fit">
    <div class="profile flex flex-col items-center justify-center gap-6">
        <img src="{{ asset('assets/img/Prestasi.jpeg') }}" alt="Foto Profile"
            class="rounded-lg w-full hover:scale-105 transition-transform duration-300 shadow-lg" />
        <div class="profile-text flex flex-col items-center pb-4">
            <h2 class="heading-profile text-[28px] font-semibold uppercase">
                Awi Pratama
            </h2>
            <h5 class="sub-heading-profile ">FreshGraduate</h5>
        </div>
