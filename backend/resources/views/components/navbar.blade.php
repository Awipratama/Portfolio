<nav class="app-header navbar navbar-expand bg-body">
    ...
    <div class="container-fluid">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-md-block"><a href="{{ asset('#') }}" class="nav-link">Home</a></li>
            <li class="nav-item d-none d-md-block"><a href="{{ asset('#') }}" class="nav-link">Contact</a></li>
        </ul>
            ...
            <li class="nav-item dropdown user-menu">
                ...
                <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                    ...
                    <li class="user-body">
                        <!--begin::Row-->
                        <div class="row">
                            <div class="col-4 text-center"><a href="{{ asset('#') }}">Followers</a></div>
                            <div class="col-4 text-center"><a href="{{ asset('#') }}">Sales</a></div>
                            <div class="col-4 text-center"><a href="{{ asset('#') }}">Friends</a></div>
                        </div>
                        <!--end::Row-->
                    </li>
                    <!--end::Menu Body-->
